...
$price = $stripe->prices->retrieve('price_1LgKsyDUPbcuEhd2JPsSJDou',[]);
?>
<html>
  <style>
    body {
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="#">Graphic card website</a>
...
<div class="container text-center">
  <div class="row justify-content-md-center">
      <div class="product">
        <div class="col"></br>
          <img src="<?php echo array_pop($product->images); ?>" alt="<?php echo $product->name; ?>" width="325" height="350" />
        </div>
          <div class="description">
            <div class="col">
              ...
              <h5><?php echo strtoupper($price->currency); ?> <?php echo $price->unit_amount_decimal; ?></h5>
                <form action="/stripe2/my-product.php" method="POST">
